...
public abstract class LayOut {
	...
	private static Image img2 = new ImageIcon("src/image/border3.png")
			.getImage();
	private static final int size = 7;
	private static int imgW = img2.getWidth(null);
	private static int imgH = img2.getHeight(null); // 文件长宽

	protected int x ;
	protected int y; // 边框在panel中坐标
	protected int w ;
	protected int h; // 边框长宽
